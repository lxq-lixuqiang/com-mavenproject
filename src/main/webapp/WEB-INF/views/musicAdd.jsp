...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/musicAdd.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">音乐数据</a><span>&#155;</span><a href="musicSinger">音乐歌手</a><span>&#155;</span><a href="musicSelect">歌曲</a><span>&#155;</span>添加歌曲</p>
						</div>
						...
						<form:form modelAttribute="musicFormBean" enctype="multipart/form-data" id="form">
							<form:hidden value="${sessionScope.musicSelect_musicSingerId}" path="musicSinger.id"/>
		...
		<script src="assets/pages/scripts/musicAdd.js"></script>
	</body>
</html>
