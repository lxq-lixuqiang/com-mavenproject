...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/musicSingerAdd.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">音乐数据</a><span>&#155;</span><a href="musicSinger">音乐歌手</a><span>&#155;</span>添加歌手</p>
						</div>
		...
		<script src="assets/pages/scripts/musicSingerAdd.js"></script>
	</body>
</html>
