...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/musicSongsheetAdd.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">音乐数据</a><span>&#155;</span><a href="musicSongsheet">音乐歌单</a><span>&#155;</span>添加歌单</p>
						</div>
		...
		<script src="assets/pages/scripts/musicSongsheetAdd.js"></script>
	</body>
</html>
