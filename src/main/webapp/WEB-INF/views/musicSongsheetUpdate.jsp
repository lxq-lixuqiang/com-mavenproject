...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/musicSongsheetUpdate.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">音乐数据</a><span>&#155;</span><a href="musicSongsheet">音乐歌单</a><span>&#155;</span>修改歌单</p>
						</div>
						<input type="hidden" value="${requestScope.msg}" id="msg"/>
						
						<form:form modelAttribute="musicSongsheetFormBean" enctype="multipart/form-data" id="form">
							<form:hidden path="id"/>
							<div class="form-group input-group">
								<div id="wrapper" class="divImgHeader">
									<div id="image-holder" class="text-center divImg"><img class="imgClass" src="${pageContext.request.contextPath}/assets/pages/img/musicSongsheetImg/${sessionScope.picture}"></div> 
								</div>
							 </div>
							...
							<div class="form-group input-group">
								<div class="has-float-label textCenter">
									...
									<a href="musicSongsheet" class="btn btn-default">
		...
		<script src="assets/pages/scripts/musicSongsheetUpdate.js"></script>
	</body>
</html>
