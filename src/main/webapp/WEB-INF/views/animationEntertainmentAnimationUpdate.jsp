...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/animationEntertainmentAnimationUpdate.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">动漫数据</a><span>&#155;</span><a href="animationEntertainmentAnimation">娱乐动漫</a><span>&#155;</span>修改娱乐动漫</p>
						</div>
							...
							<div class="form-group input-group">
								<div id="wrapper" class="divImgHeader">
									<div id="image-holder" class="text-center divImg">
										<div id="image-holder" class="text-center divImg"><img class="imgClass" src="${pageContext.request.contextPath}/assets/pages/img/animationEntertainmentAnimationImg/${sessionScope.picture}"></div>
									</div> 
								</div>
							 </div>
		...
		<script src="assets/pages/scripts/animationEntertainmentAnimationUpdate.js"></script>
	</body>
</html>
