...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/gameUpdate.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">游戏数据</a><span>&#155;</span><a href="gameInfo">游戏信息</a><span>&#155;</span>修改游戏信息</p>
						</div>
							...
							<div class="form-group input-group">
								<div id="wrapper" class="divImgHeader">
									<div id="image-holder" class="text-center divImg">
										<img class="imgClass" src="${pageContext.request.contextPath}/assets/pages/img/gameTheme/${sessionScope.picture}">
									</div> 
								</div>
							 </div>
							...
							<div class="form-group input-group">
							 ...
							 <div class="form-group input-group radiobuttonClass">
								<span class="has-float-label">
									<form:select cssClass="form-control" path="language" items="${sessionScope.language.entrySet()}" itemLabel="value" itemValue="key" ></form:select>
		...
		<script src="assets/pages/scripts/gameUpdate.js"></script>
	</body>
</html>
