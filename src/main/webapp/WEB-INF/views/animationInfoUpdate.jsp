...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/animationInfoUpdate.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">动漫数据</a><span>&#155;</span><a href="animationInfo">动漫信息</a><span>&#155;</span>修改动漫信息</p>
						</div>
						...
						<form:form modelAttribute="animationInfoFormBean" enctype="multipart/form-data" id="form">
							<form:hidden path="id"/>
							<input type="hidden" id="animationInfoTypes" value="${sessionScope.animationInfoTypes}" />
						
							<div class="form-group input-group">
								<div id="wrapper" class="divImgHeader">
									<div id="image-holder" class="text-center divImg">
										<img class="imgClass" src="${pageContext.request.contextPath}/assets/pages/img/animationInfoImg/${sessionScope.animationInfo_picture}">
									</div> 
								</div>
							 </div>
		...
		<script src="assets/pages/scripts/animationInfoUpdate.js"></script>
	</body>
</html>
