...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/homeNavigationBarAdd.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">首页数据</a><span>&#155;</span><a href="homeNavigationBar">导航栏信息</a><span>&#155;</span>添加导航栏信息</p>
						</div>
		...
		<script src="assets/pages/scripts/homeNavigationBarAdd.js"></script>
	</body>
</html>
