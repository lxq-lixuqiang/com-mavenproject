...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/wallpaperThemeUpdate.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">壁纸数据</a><span>&#155;</span><a href="wallpaperTheme">主题壁纸</a><span>&#155;</span>修改主题壁纸</p>
						</div>
						<input type="hidden" value="${requestScope.msg}" id="msg"/>
						
						<form:form modelAttribute="wallpaperThemeFormBean" enctype="multipart/form-data" id="form">
							<form:hidden path="id"/>
							<div class="form-group input-group">
								<div id="wrapper" class="divImgHeader">
									<div id="image-holder" class="text-center divImg"><img class="imgClass" src="${pageContext.request.contextPath}/assets/pages/img/wallpaperImg/${sessionScope.wallpaper}"></div> 
								</div>
							 </div>
							...
							<div class="form-group input-group">
							 ...
							 <div class="form-group input-group labelClass">
							  	<span class="has-float-label">
									<form:select path="wallpaperType.id" cssClass="form-control" items="${sessionScope.wallpaperType}" itemLabel="name" itemValue="id" />
									<label for="wallpaperType.id">类型</label>
								</span>
								<form:errors cssClass="errorInfo" path="wallpaperType" />
							</div> 
		...
		<script src="assets/pages/scripts/wallpaperThemeUpdate.js"></script>
	</body>
</html>
