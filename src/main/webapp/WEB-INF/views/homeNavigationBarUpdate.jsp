...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/homeNavigationBarUpdate.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">首页数据</a><span>&#155;</span><a href="homeNavigationBar">导航栏信息</a><span>&#155;</span>修改导航栏信息</p>
						</div>
						<input type="hidden" value="${requestScope.msg}" id="msg"/>
						
						<form:form modelAttribute="homeNavigationBarFormBean" enctype="multipart/form-data" id="form">
							<div class="form-group input-group">
								<div id="wrapper" class="divImgHeader">
									<div id="image-holder" class="text-center divImg">
										<div id="image-holder" class="text-center divImg"><img class="imgClass" src="${pageContext.request.contextPath}/assets/pages/img/homeNavigationBarImg/${sessionScope.picture}"></div> 
									</div> 
								</div>
							 </div>
							...
							<div class="form-group input-group">
							 ...
							 <div class="form-group input-group">
							  	<span class="has-float-label inputClass">
									<form:input path="title" cssClass="form-control" placeholder="请输入名称"/>
							 ...
							 <div class="form-group input-group">
							  	<span class="has-float-label inputClass">
									<form:input path="backgroundColor" cssClass="form-control" placeholder="请输入背景颜色"/>
									<label for="backgroundColor">背景颜色</label>
								</span>
								<form:errors cssClass="errorInfo" path="backgroundColor" />
							 </div>
							  ...
							  <div class="form-group input-group">
								<div id="wrapper has-float-label" class="input-group position-relative">
									...
									<span class="input-group-addon">请选择</span>
									<input disabled id="homeNavigationBar" class="form-control" />
								</div>
								<form:errors cssClass="errorInfo" path="homeNavigationBar" />
							 </div>
							 
							 <div class="form-group input-group">
							  	<span class="has-float-label inputClass">
									<form:input path="homeNavigationBarPath" cssClass="form-control" placeholder="请输入其他资源路径"/>
									<label for="homeNavigationBarPath">其他资源路径</label>
								</span>
								<form:errors cssClass="errorInfo" path="homeNavigationBarPath" />
							 </div> 
							...
							<div class="form-group input-group">
								<div class="has-float-label textCenter">
									...
									<a href="homeNavigationBar" class="btn btn-default">
		...
		<script src="assets/pages/scripts/homeNavigationBarUpdate.js"></script>
	</body>
</html>
