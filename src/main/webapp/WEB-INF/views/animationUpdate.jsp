...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/animationUpdate.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">动漫数据</a><span>&#155;</span><a href="animationInfo">动漫信息</a><span>&#155;</span><a href="animationSelect">动漫视频</a><span>&#155;</span>修改视频</p>
						</div>
							...
							<form:hidden value="${sessionScope.animationSelect_animationInfoId}" path="animationInfoId.id"/>
							 ...
							 <div class="form-group input-group borderClass">
								<div id="wrapper has-float-label" class="input-group position-relative">
									...
									<input disabled id="animation" name="animation" class="form-control" />
								</div>
		...
		<script src="assets/pages/scripts/animationUpdate.js"></script>
	</body>
</html>
