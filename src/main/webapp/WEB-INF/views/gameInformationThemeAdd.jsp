...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/gameInformationThemeAdd.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">游戏数据</a><span>&#155;</span><a href="gameInformationTheme">游戏资讯</a><span>&#155;</span>添加游戏资讯</p>
						</div>
		...
		<script src="assets/pages/scripts/gameInformationThemeAdd.js"></script>
	</body>
</html>
