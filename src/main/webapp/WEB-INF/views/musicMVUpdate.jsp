...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/musicMVUpdate.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">音乐数据</a><span>&#155;</span><a href="musicSinger">音乐歌手</a><span>&#155;</span><a href="musicMV">MV</a><span>&#155;</span>修改MV</p>
						</div>
						<input type="hidden" value="${requestScope.msg}" id="msg"/>
						
						<form:form modelAttribute="musicMVFormBean" enctype="multipart/form-data" id="form">
							<form:hidden value="${sessionScope.musicMV_musicSingerId}" path="musicSinger.id"/>
							<div class="form-group input-group">
								<div id="wrapper" class="divImgHeader">
									<div id="image-holder" class="text-center divImg">
										<img class="imgClass" src="${pageContext.request.contextPath}/assets/pages/img/musicMVImg/${sessionScope.themePicture}">
									</div> 
								</div>
							 </div>
							...
							<div class="form-group input-group">
								...
								<form:errors cssClass="errorInfo" path="themePicture" />
							 </div>
							 ...
							 <div class="form-group input-group">
								<div id="wrapper has-float-label" class="input-group position-relative">
									...
									<span class="input-group-addon">请选择</span>
									<input disabled id="mv" class="form-control" />
								</div>
								<form:errors cssClass="errorInfo" path="mv" />
							 </div>
							
							 <div class="form-group input-group">
							  	<span class="has-float-label inputClass">
									<form:input path="themeName" cssClass="form-control" placeholder="请输入名称"/>
									<label for="themeName">名称</label>
								</span>
								<form:errors cssClass="errorInfo" path="themeName" />
							 </div> 
							...
							<div class="form-group input-group">
								<div class="has-float-label textCenter">
									...
									<a href="musicMV" class="btn btn-default">
		...
		<script src="assets/pages/scripts/musicMVUpdate.js"></script>
	</body>
</html>
