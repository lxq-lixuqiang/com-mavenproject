...
<html lang="zh-CN">
  	<head>
		...
		<link href="assets/pages/css/musicSongsheetInfo.css" rel="stylesheet">
	</head>
	<body>
				...
				<div class="section-botton">
					...
					<div class="section-botton-right">
						<div id="currentLocation">
							<p><a href="dataManagement">音乐数据</a><span>&#155;</span><a href="musicSongsheet">音乐歌单</a><span>&#155;</span>查看歌曲</p>
						</div>
						...
						<div class="controllerSize">
							...
							<p class="findClass">
								<input type="text" autocomplete="off" id="name" value="${requestScope.musicSongsheetInfo_name}" placeholder="搜索歌手或歌名" maxlength="10" /><img id="select" alt="搜索" src="${pageContext.request.contextPath}/assets/pages/img/common/ImageSelect01.png" />
							</p>
							...
							<div class="text-right buttonMarginSize">
								<a href="musicSongsheetInfoUpdate?songsheetId=${sessionScope.musicSongsheetInfo_songsheetId}" class="btn btn-info btn-sm">
									<span class="glyphicon glyphicon-pencil"></span> 修改歌单
								</a>
								<a href="musicSongsheet" class="btn btn-default btn-sm">
							...
							<c:if test="${notNull}">
								<div id="pageSizeAndpageNum">
									<ul>
										...
										<c:forEach var="pagingButton" items="${requestScope.musicSongsheetInfo_pagingButton}">
		...
		<script src="assets/pages/scripts/musicSongsheetInfo.js"></script>
	</body>
</html>
