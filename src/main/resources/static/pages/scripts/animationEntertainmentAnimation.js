var AnimationEntertainmentAnimation=function(){
	...
	var pagingButton=function(){
		$(".ulNotClick").click(function(){
			...
			location.href="animationEntertainmentAnimation?pageNum="+pageNum;
		});
	}
	...
	function seach(){
		...
		location.href="animationEntertainmentAnimation?pageNum=1&entertainmentTypeId="+entertainmentTypeId+"&name="+name;
	}
		...
		$(".delete").click(function(){
			...
			Lobibox.confirm({
			    ...
			    callback: function ($this, type, ev) {
			        if(type == 'yes'){
			    		location.href="animationEntertainmentAnimationDelete?id="+id;
			        }
			    }
			});
		});
...
$(function(){
	AnimationEntertainmentAnimation.init();
});