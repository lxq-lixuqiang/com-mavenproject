var CommonUserHeadPicture=function(){
	...
	var pagingButton=function(){
		$(".ulNotClick").click(function(){
			...
			var wallpaperThemeId=$("#wallpaperThemeId").val();
			location.href="wallpaperSelect?pageNum="+pageNum+"&wallpaperThemeId="+wallpaperThemeId;
		});
	}
	...
	var addButton=function(){
		$("#add").click(function(){
			var wallpaperThemeId=$("#wallpaperThemeId").val();
			location.href="wallpaperAdd?wallpaperThemeId="+wallpaperThemeId;
		});
	}
		...
		$(".delete").click(function(){
			...
			Lobibox.confirm({
			    ...
			    callback: function ($this, type, ev) {
			        if(type == 'yes'){
						location.href="wallpaperDelete?id="+id;
			        }
			    }
			});
		});
	...
	var updateButton=function(){
		$(".update").click(function(){
			...
			$(this).parent().prev().find(" .imgSize").attr("style","border:2px solid #5BC0DE;");
	...
	var cancelButton=function(){
		$(".cancel").click(function(){
			...
			$(this).parent().prev().find(" .imgSize").attr("style","border:2px solid #fff;");
			var num=$(this).data("id");
