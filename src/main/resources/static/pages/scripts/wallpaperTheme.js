var WallpaperTheme=function(){
	...
	var pagingButton=function(){
		$(".ulNotClick").click(function(){
			...
			location.href="wallpaperTheme?pageNum="+pageNum;
		});
	}
	...
	function seach(){
		...
		location.href="wallpaperTheme?pageNum=1&theme="+theme+"&typeId="+typeId;
	}
		...
		$(".delete").click(function(){
			...
			Lobibox.confirm({
			    ...
			    callback: function ($this, type, ev) {
			        if(type == 'yes'){
			    		location.href="wallpaperThemeDelete?id="+id;
			        }
			    }
			});
		});
